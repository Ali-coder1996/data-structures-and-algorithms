...
const raisedToTheThird = (arr) => {
  ...
  const arrayOFPow=[];
  arr.forEach(elemet =>{
    arrayOFPow.push( Math.pow(elemet,3));
  });
  return arrayOFPow;
};
...
const addOne = (arr) => {
  // Solution code here...
  let incremented = arr.map(elemet => {
    return elemet +1;
  });
  return incremented;
};
...
const forEachTwoToThe = (arr) => {
  ...
  let forloop =[];
  arr.forEach(elemet => {
    forloop.push(Math.pow(2, elemet));
  });
  return forloop;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let array = arr.map(elemet => {
    return (Math.pow(2, elemet));
  });
  return array;
};
